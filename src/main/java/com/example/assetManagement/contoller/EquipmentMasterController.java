...
public class EquipmentMasterController {
	...
	@PutMapping("/update")
    public ResponseEntity<?> updateEquipment( @RequestBody EquipmentMasterModel equipmentMasterModel) {
		equipmentMasterModel=iEquipmentMaster.update(equipmentMasterModel);
